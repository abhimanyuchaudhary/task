...
## Sample Google Task API call from node - see landingpage.js for exact usage
...
# TO DO
  ...
  * Api calls (see landingpage.js)https://www.fullstackreact.com/articles/using-create-react-app-with-a-server/  
  * Front-End
